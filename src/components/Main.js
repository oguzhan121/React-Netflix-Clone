...
const Main = () => {
    ...
    useEffect(() => {
        sendRequest.get(requests.requestPopular)
          .then((res) => {
        ...
        <div className="w-full h-[550px] text-white">
            <div className="w-full h-full">
                ...
                <div className="absolute w-full top-[20%] p-4 md:p-8">
                    ...
                    <div className="my-4">
                        <button className="border bg-gray-300 text-black border-gray-300 pt-2 px-5">Play</button>
                        <button className="border text-white border-gray-300 pt-2 px-5 ml-4">Watch Later</button>
                    </div>
